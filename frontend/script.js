...
function openBooking(eventName, price, date, location) {
...
.addEventListener("submit", async function(event) {
    ...
    try {
        ...
        document.getElementById("billBookingId").innerText =
            data.booking_id;

        document.getElementById("billName").innerText =
            data.customer.name;

        document.getElementById("billEmail").innerText =
            data.customer.email;

        document.getElementById("billPhone").innerText =
            data.customer.phone;

        document.getElementById("billEvent").innerText =
            data.event;

        document.getElementById("billTickets").innerText =
            data.quantity;
